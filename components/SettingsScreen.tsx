...
export const SettingsScreen: React.FC<Props> = ({ initialTitle, ministryId, theme, onToggleTheme, onSaveTitle, onAnnounceUpdate, onEnableNotifications }) => {
  ...
  const handleMigration = async () => {
      ...
      confirmAction(
          "Migrar e Limpar Dados Antigos?",
          "ATENÇÃO: Essa ação moverá todos os membros, eventos e escalas do sistema antigo (app_storage) para o novo banco de dados SQL e APAGARÁ o cache antigo. Isso resolve o problema de dados presos ou não exibidos.",
          async () => {
              setMigrating(true);
                 ...
                 <div className="md:col-span-2 mt-2 pt-4 border-t border-zinc-100 dark:border-zinc-700 space-y-3">
                     ...
                     >
                         ...
                         <span className="text-sm font-bold">
                             {migrating ? "Migrando..." : "Migrar e Limpar Dados Antigos"}
                         </span>
                     </button>
                     <p className="text-[10px] text-zinc-400 text-center">
                         Use se os dados de eventos ou membros estiverem desatualizados ou duplicados (Mover do app_storage para SQL).
                     </p>
