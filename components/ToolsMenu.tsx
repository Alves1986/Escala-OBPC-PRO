...
export const ToolsMenu: React.FC<Props> = ({ onExportIndividual, onWhatsApp, onCSV, onImportCSV, onClearMonth, allMembers }) => {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-zinc-800 rounded-xl shadow-xl border border-zinc-200 dark:border-zinc-700 z-50 overflow-hidden">
